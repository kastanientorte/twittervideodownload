...
const AdditionalInfoSection = () => (
    ...
    <div className="container pb-8 pt-8">
      <div className="row justify-content-center align-items-center">
        <div className="col-md-6">
          <h2 className="fw-bold h1 mb-3 text-dark">Twitter Video Download</h2>
          <p className='mb-4'>
        ...
        <div className="col-md-4">
          <img
            src="/assets/img/Twitter_Video_downloader_app.png"
            className="img-fluid"
  ...
  <section className="pb-8 pt-8">
    <div className="container pb-8 pt-8">
      <div className="row justify-content-center align-items-center">
        <div className="col-md-6">
          <h2 className="fw-bold h1 mb-3 text-dark">Twitter to Mp4 download</h2>
          <p className='mb-4'>
        ...
        <div className="col-md-4">
          <img
            src="/assets/img/Download_Twitter_video.png"
            className="img-fluid"
            alt="Additional Information"
            title="Additional Information"
            loading='lazy'
